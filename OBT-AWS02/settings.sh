...
OBT_SYSTEM_CORE_SIZE=unlimited
...
#REGRESSION_EXCLUDE_CLASS="-e embedded-r,embedded-js,3rdpartyservice,mongodb,python2 --ef compileOptions.ecl,cppembed.ecl"
REGRESSION_EXCLUDE_CLASS="-e embedded-r,embedded-js,3rdpartyservice,mongodb,python2 --ef compileOptions.ecl"
