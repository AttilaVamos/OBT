...
PERF_SUPRESS_PLUGINS=' -D INCLUDE_PLUGINS=1 -D MAKE_CASSANDRAEMBED=1 -D SUPPRESS_COUCHBASEEMBED=ON -D SUPPRESS_MYSQLEMBED=ON -D USE_MYSQL=OFF -D USE_AZURE=OFF -D USE_AWS=OFF'
