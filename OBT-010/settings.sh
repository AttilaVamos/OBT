...
then
    ...
    # For obtSequencer.sh 
    BRANCHES_TO_TEST=( 'candidate-7.10.x' 'candidate-7.12.x' 'candidate-8.0.x' 'candidate-8.2.x' 'master' )
    ...
    RUN_6=("BRANCH_ID=candidate-8.2.x")
    RUN_7=("BRANCH_ID=candidate-8.2.x" "REGRESSION_NUMBER_OF_THOR_CHANNELS=4") 
