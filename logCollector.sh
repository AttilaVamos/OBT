...
then
    ...
    echo "Hthor log not found, delete $(rm -v HthorLogCollection-$YM.log) and skip collection."
fi
...
then
    ...
    echo "Thor log not found, delete $(rm -v ThorLogCollection-$YM.log) and skip collection."
fi
...
then
    ...
    echo "Roxie log not found, delete $(rm -v RoxieLogCollection-$YM.log) and skip collection."
fi
...
then
    ...
    echo "Unit test log not found, delete $(rm -v UnittestsLogCollection-$YM.log) and skip collection."
fi
...
then
    ...
    echo "ML test log not found, delete $(rm -v MlLogCollection-$YM.log) and skip collection."
fi
...
then
    ...
    echo "WUTool test log not found, delete $(rm -v WutooltestLogCollection-$YM.log) and skip collection."
fi
...
then
    ...
    echo "Build test log not found, delete $(rm -v BuildLogCollection-$YM.log) and skip collection."
fi
...
then
    ...
    echo "Misc (report.htm, GlobalExclusion and git_2days) test log not found, delete $(rm -v MiscLogCollection-$YM.log) and skip collection."
fi
