...
then
    ...
    echo "Hthor log not found,$([ -f HthorLogCollection-$YM.log ] && rm -v HthorLogCollection-$YM.log) and skip collection."
fi
...
then
    ...
    echo "Thor log not found,$([ -f ThorLogCollection-$YM.log ] && rm -v ThorLogCollection-$YM.log) and skip collection."
fi
...
then
    ...
    echo "Roxie log not found,$([ -f RoxieLogCollection-$YM.log ] && rm -v RoxieLogCollection-$YM.log) and skip collection."
fi
...
then
    ...
    echo "Unit test log not found,$([ -f UnittestsLogCollection-$YM.log ] && rm -v UnittestsLogCollection-$YM.log) and skip collection."
fi
...
then
    ...
    echo "ML test log not found,$([ -f MlLogCollection-$YM.log ] && rm -v MlLogCollection-$YM.log) and skip collection."
fi
...
then
    ...
    echo "WUTool test log not found,$([ -f WutooltestLogCollection-$YM.log ] && rm -v WutooltestLogCollection-$YM.log) and skip collection."
fi
...
then
    ...
    echo "Build test log not found,$([ -f BuildLogCollection-$YM.log ] && rm -v BuildLogCollection-$YM.log) and skip collection."
fi
...
then
    ...
    echo "Misc (report.htm, GlobalExclusion and git_2days) test log not found,$([ -f MiscLogCollection-$YM.log ] && rm -v MiscLogCollection-$YM.log) and skip collection."
fi
