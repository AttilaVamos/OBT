...
SuppressAnalyserWarnings()
{
    ...
    do
        ...
        then
            ...
            (echo "#onwarning(5820, ignore); // Suppress analyser warning" ; echo "#onwarning(30003, ignore);"; echo "#onwarning(30004, ignore); // Suppress Cost Optimizer warning" ; cat $file) >${file}.new
            mv ${file}.new $file
